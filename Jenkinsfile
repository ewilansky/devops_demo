...
node {
    stage('AppImageBuild') {
        ...
        def custom_app_image = docker.build("springboot", "-u root:root --build-arg JAR_FILE=./spring_boot_app/build/libs/gs-spring-boot-docker-0.1.0.jar ./spring_boot_app")
